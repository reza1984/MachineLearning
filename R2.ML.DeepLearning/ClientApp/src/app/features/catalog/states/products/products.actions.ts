...
export enum ProductActionTypes {
  ...
  SetProductGridSettings = '[Product] Set Product Grid Settings',
  Load = '[Product] Load',
...
export class SetProductGridSettings implements Action {
  readonly type = ProductActionTypes.SetProductGridSettings;

  constructor(public payload: ProductGridSettings) {}
}
