...
var map = {
	"./features/follower/follower.module": [
		"./src/app/features/follower/follower.module.ts",
		"default~features-follower-follower-module~views-dashboard-dashboard-module",
		"features-follower-follower-module"
	],
	"./features/image-processing/image-processing.module": [
...
/* harmony import */ var _instagram_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./instagram.service */ "./src/app/instagram.service.ts");




var AppComponent = /** @class */ (function () {
    function AppComponent(router, instagramService) {
        this.router = router;
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.instagramService.checkInstgramState().subscribe(function (state) {
            // need login
            if (state === 0) {
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _instagram_service__WEBPACK_IMPORTED_MODULE_3__["InstagramService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _state_app_reducer__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./state/app.reducer */ "./src/app/state/app.reducer.ts");
...
var APP_CONTAINERS = [_containers__WEBPACK_IMPORTED_MODULE_7__["DefaultLayoutComponent"]];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            imports: [
                ...
                _ngrx_store__WEBPACK_IMPORTED_MODULE_17__["StoreModule"].forRoot(_state_app_reducer__WEBPACK_IMPORTED_MODULE_21__["applicationReducer"]),
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'follower',
                loadChildren: './features/follower/follower.module#FollowerModule'
            },
            {
                path: 'image_processing',
                loadChildren: './features/image-processing/image-processing.module#ImageProcessingModule'
            },
        ]
    }
];
...
var InstagramService = /** @class */ (function () {
    ...
    InstagramService.prototype.getFollowers = function () {
        var url = 'api/Instagram/Followers';
        return this.http.get(url);
    };
    InstagramService.prototype.getFollowerImages = function (userName) {
        var url = "api/instagram/Follower/" + userName;
        return this.http.get(url);
    };
    InstagramService.prototype.saveFollowerImage = function (model) {
        var url = 'api/Instagram/SaveFollowerImage';
        return this.http.post(url, model);
    };
    InstagramService.prototype.deleteFollowerImage = function (model) {
        var url = 'api/Instagram/DeleteFollowerImage';
        return this.http.post(url, model);
    };
    InstagramService.prototype.checkInstgramState = function () {
        var url = 'api/Instagram';
        return this.http.get(url);
    };
    InstagramService.prototype.login = function (loginViewModel) {
        var url = 'api/Instagram/Login';
        return this.http.post(url, loginViewModel);
    };
    InstagramService.prototype.twoFactor = function (loginViewModel) {
        var url = 'api/Instagram/TwoFactor';
        return this.http.post(url, loginViewModel);
    };
    InstagramService.prototype.startTraining = function () {
        var url = 'api/Instagram/StartTrain';
        return this.http.get(url);
    };
...
/*!**************************************!*\
  !*** ./src/app/state/app.actions.ts ***!
  \**************************************/
/*! exports provided: ApplicationActionTypes, SetCurrentTheme */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApplicationActionTypes", function() { return ApplicationActionTypes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SetCurrentTheme", function() { return SetCurrentTheme; });
var ApplicationActionTypes;
(function (ApplicationActionTypes) {
    ApplicationActionTypes["SetCurrentTheme"] = "[Application] Set Current Theme";
})(ApplicationActionTypes || (ApplicationActionTypes = {}));
var SetCurrentTheme = /** @class */ (function () {
    function SetCurrentTheme(payload) {
        this.payload = payload;
        this.type = ApplicationActionTypes.SetCurrentTheme;
    }
...
function applicationReducer(state, action) {
    ...
    switch (action.type) {
        case _app_actions__WEBPACK_IMPORTED_MODULE_1__["ApplicationActionTypes"].SetCurrentTheme:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { currentTheme: action.payload });
        default:
            return state;
    }
}
...
module.exports = "<div class=\"app-body\">\n  <main class=\"main d-flex align-items-center\">\n    <div class=\"container\">\n      <div class=\"row\">\n        <div class=\"col-md-8 mx-auto\">\n          <div class=\"card-group\">\n            <div class=\"card p-4\">\n              <div class=\"card-body\">\n                <form>\n                  <h1>Login</h1>\n                  <p class=\"text-muted\">Sign In to your instagram account</p>\n                  <div class=\"input-group mb-3\" [hidden]=\"twoFactorRequired\">\n                    <div class=\"input-group-prepend\">\n                      <span class=\"input-group-text\"><i class=\"icon-user\"></i></span>\n                    </div>\n                    <input #userName type=\"text\" class=\"form-control\" placeholder=\"Username\" autocomplete=\"username\" required>\n                  </div>\n                  <div class=\"input-group mb-4\" [hidden]=\"twoFactorRequired\">\n                    <div class=\"input-group-prepend\">\n                      <span class=\"input-group-text\"><i class=\"icon-lock\"></i></span>\n                    </div>\n                    <input #password type=\"password\" class=\"form-control\" placeholder=\"Password\" autocomplete=\"current-password\" required>\n                  </div>\n\n                  <div class=\"input-group mb-4\" [hidden]=\"!twoFactorRequired\">\n                    <div class=\"input-group-prepend\">\n                      <span class=\"input-group-text\"><i class=\"icon-speech\"></i></span>\n                    </div>\n                    <input #code type=\"text\" class=\"form-control\" placeholder=\"Code\" autocomplete=\"current-password\" required>\n                  </div>\n                  <div class=\"row\">\n                    <div class=\"col-6\" *ngIf=\"!twoFactorRequired\">\n                      <button type=\"button\" class=\"btn btn-primary px-4\" (click)=\"login(userName, password)\">Login</button>\n                    </div>\n                    <div class=\"col-6\" *ngIf=\"twoFactorRequired\">\n                      <button type=\"button\" class=\"btn btn-primary px-4\" (click)=\"sendCode(code)\">Code</button>\n                    </div>\n                    <div class=\"col-6 text-right\">\n                      <!-- <button type=\"button\" class=\"btn btn-link px-0\">Forgot password?</button> -->\n                    </div>\n                  </div>\n                </form>\n              </div>\n            </div>\n            <div class=\"card text-white bg-primary py-5 d-md-down-none\" style=\"width:44%\">\n              <div class=\"card-body text-center\">\n                <div>\n                  <h2>Deep Learning</h2>\n                  <p>use instagram</p>\n                  <!-- <button type=\"button\" class=\"btn btn-primary active mt-3\">Register Now!</button> -->\n                </div>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </main>\n</div>\n"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _instagram_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../instagram.service */ "./src/app/instagram.service.ts");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(instagramService, router) {
        this.instagramService = instagramService;
        this.router = router;
    ...
    LoginComponent.prototype.sendCode = function (code) {
        var _this = this;
        this.instagramService.twoFactor({ Code: code.value }).subscribe(function (loginResult) {
            // login successfully
            if (loginResult === 0) {
                _this.twoFactorRequired = false;
            }
            else if (loginResult === 1) {
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_instagram_service__WEBPACK_IMPORTED_MODULE_2__["InstagramService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], LoginComponent);
...
module.exports = __webpack_require__(/*! D:\DeepLearning\R2.ML.DeepLearning\ClientApp\src\main.ts */"./src/main.ts");
