...
namespace R2.ML.DeepLearning.TensorFlow.Train {
    public class ModelBuilder {
        ...
        public List<ImageNetPipeline> BuildAndTrain () {
                ...
                new TextLoader.Arguments {
                    Column = new [] {
                        new TextLoader.Column ("ImagePath", DataKind.Text, 0),
                            ...
                            new TextLoader.Column ("Identifier", DataKind.Text, 2),
                    }
                });
            ...
            trainData2.ForEach (pr => ConsoleWriteImagePrediction (pr.ImagePath, pr.PredictedLabelValue, pr.Identifier, pr.Score.Max ()));
